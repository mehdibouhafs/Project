...
/**
 * Servlet implementation class getQualificationServlet
 */
@WebServlet("/getQualificationServlet")
public class getQualificationServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public getQualificationServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			PreparedStatement ps=con.prepareStatement("Select * from Qualification where idSecteur=?");
			ps.setInt(1, id);
