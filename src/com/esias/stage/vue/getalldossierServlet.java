...
/**
 * Servlet implementation class getalldossierServlet
 */
@WebServlet("/getalldossierServlet")
public class getalldossierServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public getalldossierServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			PreparedStatement ps=con.prepareStatement("Select * from dossier");
